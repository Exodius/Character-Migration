...
switch ($language) {
    ...
    case "it": {
            ...
            $write[75] = '<span style="font-size:18px"><ol>'
                    ...
                    . '<li> ATTENZIONE: i vostri items vengono conservati nella mailbox in game per pochi giorni, assicuratevi di entrare subito dopo che il vostro porting è stato accettato, altrimenti essi verranno definitivamente eliminati dal sistema!</li>'
                    . '</ol>'
                    . '</span>';
